...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'website_infromation_fetch',
          path: '/websiteInfromationFetch',
          requireAuth: true,
          builder: (context, params) => const WebsiteInfromationFetchWidget(),
        ),
        FFRoute(
          name: 'websiteDataFetched',
          path: '/websiteData',
          requireAuth: true,
