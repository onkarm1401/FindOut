...
DocumentReference? get currentUserReference =>
    loggedIn ? UserTableRecord.collection.doc(currentUser!.uid) : null;

UserTableRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserTableRecord.getDocument(UserTableRecord.collection.doc(uid))
              .handleError((_) {}),
    )
