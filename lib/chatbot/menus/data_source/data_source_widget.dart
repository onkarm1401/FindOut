...
class DataSourceWidget extends StatefulWidget {
  const DataSourceWidget({super.key});

  @override
  State<DataSourceWidget> createState() => _DataSourceWidgetState();
}

class _DataSourceWidgetState extends State<DataSourceWidget>
    with TickerProviderStateMixin {
  late DataSourceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DataSourceModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.apiResultwlo?.succeeded ?? true)) {
        await currentUserReference!.update(createUserTableRecordData(
          usedStorageFile: functions
              .calculateListValue(VectorStorageGroup.listOfUploadedFileCall
                  .usagebytes(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        _model.mFileGeneration =
                                          ...
                                          token: getRemoteConfigString(
                                              'openAI_key'),
                                          faq: valueOrDefault<String>(
                                            _model.textController2.text,
                                            'Not Avaiable',
                                          ),
                                          websiteData:
                                              functions.convertToOneline(_model
                                                  .existingDataTextController
                                                  .text),
                                          filename:
                                              'ManuallyAddedData-${getCurrentTimestamp.toString()}',
                                        );
                                        setState(() {
                                          _model.addToLogs('generating File');
                                        });
                                        setState(() {
                                          _model.addToLogs((_model
                                                      .mFileGeneration
                                                      ?.jsonBody ??
                                                  '')
                                              .toString());
                                        ...
                                        if ((_model
                                          ...
                                          if ((_model.mLinkFIleToVectorStorage
                                                  ?.succeeded ??
                                              true)) {
                                            setState(() {
                                              _model.addToLogs(
                                                  'Linked file to vector store');
                                            });
                                            setState(() {
                                              _model.addToLogs(
                                                  (_model.mLinkFIleToVectorStorage
                                                                                ...
                                                                                child: FFButtonWidget(
                                                                                  onPressed: () async {
                                                                                    ...
                                                                                    if (confirmDialogResponse) {
                                                                                      setState(() {
                                                                                        _model.existingDataTextController?.text = valueOrDefault(currentUserDocument?.websiteFetchedData, '');
                                                                                      });
                                                                                    }
                                                                                  },
                                                                                  text: 'Discard',
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: AuthUserStreamWidget(
                                                                                builder: (context) => TextFormField(
                                                                                  controller: _model.existingDataTextController,
                                                                                  focusNode: _model.existingDataFocusNode,
                                                                                  autofocus: false,
                                                                                  obscureText: false,
                                                                                  ...
                                                                                  maxLines: null,
                                                                                  validator: _model.existingDataTextControllerValidator.asValidator(context),
                                                                                ),
                                                                              ),
                                                                            ),
                                                                          ],
