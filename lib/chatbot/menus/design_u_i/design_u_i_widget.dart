...
class _DesignUIWidgetState extends State<DesignUIWidget>
  ...
  void initState() {
    ...
    _model.textController1 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.messageBroderRadius1, 0)
            .toString());
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.messageBroderRadius2, 0)
            .toString());
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.messageBroderRadius3, 0)
            .toString());
    _model.textFieldFocusNode3 ??= FocusNode();

    _model.textController4 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.messageBroderRadius4, 0)
            .toString());
    _model.textFieldFocusNode4 ??= FocusNode();

    _model.chatbotTitleTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.chatbotName, ''));
    _model.chatbotTitleFocusNode ??= FocusNode();

    _model.chatbotSubTitleTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.chatbotDescripation, ''));
    _model.chatbotSubTitleFocusNode ??= FocusNode();

    _model.placeholderTextController ??= TextEditingController(
        text:
            valueOrDefault(currentUserDocument?.chatbotTextBoxPlaceholder, ''));
    _model.placeholderFocusNode ??= FocusNode();
                                    ...
                                    children: [
                                      ...
                                      AuthUserStreamWidget(
                                        builder: (context) => TextFormField(
                                          controller:
                                              _model.chatbotTitleTextController,
                                          focusNode:
                                              _model.chatbotTitleFocusNode,
                                          onFieldSubmitted: (_) async {
                                            await currentUserReference!.update(
                                                createUserTableRecordData(
                                              chatbotName: _model
                                                  .chatbotTitleTextController
                                                  .text,
                                            ));
                                          },
                                          autofocus: false,
                                          ...
                                          validator: _model
                                              .chatbotTitleTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      Padding(
                                      ...
                                      AuthUserStreamWidget(
                                        builder: (context) => TextFormField(
                                          controller: _model
                                              .chatbotSubTitleTextController,
                                          focusNode:
                                              _model.chatbotSubTitleFocusNode,
                                          onFieldSubmitted: (_) async {
                                            await currentUserReference!.update(
                                                createUserTableRecordData(
                                              chatbotDescripation: _model
                                                  .chatbotSubTitleTextController
                                                  .text,
                                            ));
                                          },
                                      ...
                                      AuthUserStreamWidget(
                                        builder: (context) => TextFormField(
                                          controller:
                                              _model.placeholderTextController,
                                          focusNode:
                                              _model.placeholderFocusNode,
                                          onFieldSubmitted: (_) async {
                                            await currentUserReference!.update(
                                                createUserTableRecordData(
                                              chatbotTextBoxPlaceholder: _model
                                          ...
                                          validator: _model
                                              .placeholderTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ].divide(const SizedBox(height: 8.0)),
                                                                  ...
                                                                  decoration:
                                                                    ...
                                                                    borderRadius:
                                                                      ...
                                                                      bottomLeft:
                                                                        ...
                                                                        valueOrDefault(currentUserDocument?.messageBroderRadius3,
                                                                                0)
                                                                            .toDouble(),
                                                                        0.0,
                                                                      )),
                                                                      bottomRight:
                                                                          Radius.circular(
                                                                              valueOrDefault<double>(
                                                                        valueOrDefault(currentUserDocument?.messageBroderRadius4,
                                                                                0)
                                                                            .toDouble(),
                                                                        0.0,
                                                                      )),
                                                                      topLeft: Radius
                                                                          .circular(
                                                                              valueOrDefault<double>(
                                                                        valueOrDefault(currentUserDocument?.messageBroderRadius1,
                                                                                0)
                                                                            .toDouble(),
                                                                        0.0,
                                                                      )),
                                                                      topRight:
                                                                          Radius.circular(
                                                                              valueOrDefault<double>(
                                                                        valueOrDefault(currentUserDocument?.messageBroderRadius2,
                                                                                0)
                                                                            .toDouble(),
                                                                        0.0,
                                                                      )),
