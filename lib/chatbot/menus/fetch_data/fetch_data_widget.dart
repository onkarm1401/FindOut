...
class _FetchDataWidgetState extends State<FetchDataWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FetchDataModel());
                                                                  ...
                                                                  unawaited(
                                                                    () async {
                                                                      await currentUserReference!
                                                                          .update({
                                                                        ...createUserTableRecordData(
                                                                          displayName: functions.convertStringListToString(_model
                                                                              .ouputData
                                                                              .toList()),
                                                                        ),
                                                                        ...mapToFirestore(
                                                                          {
                                                                            'used_token':
                                                                                FieldValue.increment(OpenAICall.totalToken(
                                      ...
                                      if (_model.uniqueLinkFlag != true)
                                        Padding(
                                          ...
                                          child: FlutterFlowCheckboxGroup(
                                            options: _model.uniqueURL.toList(),
                                            onChanged: (val) async {
                                              setState(() => _model
