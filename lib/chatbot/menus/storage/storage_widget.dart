        ...
        while (_model.counter! > 0) {
          ...
          if ((_model.apiResult3z8?.succeeded ?? true)) {
            setState(() {
              ...
              _model.addToUsuages(
                  VectorStorageGroup.filenameUploadedFileCall.bytes(
                (_model.apiResult3z8?.jsonBody ?? ''),
              )!);
                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.apiResultj8t = await VectorStorageGroup
                                    .uploadFileCall
                                    .call(
                                  file: _model.uploadedLocalFile,
                                  token: getRemoteConfigString('openAI_key'),
                                );
                                if ((_model.apiResultj8t?.succeeded ?? true)) {
                                  _model.apiResult0ou = await VectorStorageGroup
                                  ...
                                  if ((_model.apiResult0ou?.succeeded ??
                                    ...
                                    _model.apiResult8zm =
                                      ...
                                      instructions: valueOrDefault(
                                          currentUserDocument?.userInstruction,
                                          ''),
