                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'What input you need from intrested candidate ',
                          style:
                        ...
                        Padding(
                          ...
                          child: FlutterFlowChoiceChips(
                            options: const [
                              ChipData('Candidate name'),
                              ChipData('Contact number'),
                              ChipData('Contact EMail'),
                              ChipData('Existing company name'),
                              ChipData('Total Experience'),
                              ChipData('Current CTC'),
                              ChipData('Expected CTC'),
                              ChipData('Linkdln profile URL'),
                              ChipData('Experience summary'),
                              ChipData('Career gap'),
                              ChipData('Notice period')
                            ],
                            onChanged: (val) =>
