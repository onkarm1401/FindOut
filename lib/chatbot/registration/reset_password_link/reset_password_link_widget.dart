                    ...
                    Flexible(
                      child: Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.network(
                            'https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHx3ZWJzaXRlfGVufDB8fHx8MTcxNjEwMTM3MXww&ixlib=rb-4.0.3&q=80&w=1080',
                            width: 300.0,
                            height: 200.0,
                            fit: BoxFit.cover,
                          ),
                                                ...
                                                child: Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 0.0, 0.0, 6.0),
                                                  child: Text(
                                                    'Please enter the email address and we will send password reset instructions',
                                                    textAlign: TextAlign.center,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
