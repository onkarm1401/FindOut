...
class _WebsiteInfromationFetchWidgetState
  ...
  Widget build(BuildContext context) {
    return Title(
        title: 'website_infromation_fetch',
                                                                    ...
                                                                    if ((_model
                                                                      ...
                                                                      _model.fileGenerationAPI =
                                                                        ...
                                                                        filename: valueOrDefault(
                                                                            ...
                                                                            ''),
                                                                        websiteData: functions.convertStringListToString(_model
                                                                            .fetchedInfo
                                                                            .toList()),
                                                                        faq: valueOrDefault(
                                                                      ...
                                                                      if ((_model
                                                                        ...
                                                                        _model.addFileToVectorStorage = await VectorStorageGroup
                                                                        ...
                                                                        if ((_model.addFileToVectorStorage?.succeeded ??
                                                                            true)) {
                                                                          await Future.delayed(
                                                                          ...
                                                                          _model.addFileToAsistent = await OpenAIAssistentGroup
                                                                            ...
                                                                            instructions:
                                                                                valueOrDefault(currentUserDocument?.chatbotInstruction, ''),
                                                                            chatbotName:
                                                                                valueOrDefault(currentUserDocument?.chatbotName, ''),
                                                                            vectorStoreIds:
                                                                                valueOrDefault(currentUserDocument?.vectorStoresId, ''),
                                                                            token:
                                                                                getRemoteConfigString('openAI_key'),
                                                                          );

                                                                          if ((_model.addFileToAsistent?.succeeded ??
                                                                              true)) {
                                                                            ...
                                                                            await currentUserReference!.update(createUserTableRecordData(
                                                                              website: _model.textController1.text,
                                                                              websiteFetchedData: functions.convertStringListToString(_model.fetchedInfo.toList()),
                                                                            ));
                                                                          } else {
                                                                            ScaffoldMessenger.of(context).showSnackBar(
                                                                              SnackBar(
                                                                        ...
                                                                        ScaffoldMessenger.of(context)
                                                                          ...
                                                                          SnackBar(
                                                                            content:
                                                                                Text(
                                                                              (_model.fileGenerationAPI?.jsonBody ?? '').toString(),
                                                                              style: TextStyle(
                                                                                color: FlutterFlowTheme.of(context).primaryText,
                                                                              ),
                                                                            ),
                                                                      ...
                                                                      ScaffoldMessenger.of(
                                                                        ...
                                                                        SnackBar(
                                                                          content:
                                                                              Text(
                                                                            (_model.recreateVectorStore?.jsonBody ?? '').toString(),
                                                                            style:
                                                                                TextStyle(
                                                                              color: FlutterFlowTheme.of(context).primaryText,
                                                                            ),
                                                                    ...
                                                                    if ((_model
                                                                      ...
                                                                      ScaffoldMessenger.of(
                                                                        ...
                                                                        SnackBar(
                                                                          content:
                                                                              Text(
                                                                            (_model.addVectorStorageToAssisent?.jsonBody ?? '').toString(),
                                                                            style:
                                                                                TextStyle(
                                                                              color: FlutterFlowTheme.of(context).primaryText,
                                                                            ),
                                                                      ...
                                                                      if ((_model
                                                                        ...
                                                                        if ((_model.mFileGenerationAPI?.succeeded ??
                                                                          ...
                                                                          if ((_model.mAddFileToVectorStorage?.succeeded ??
                                                                            ...
                                                                            _model.mAddFileToAsistent =
                                                                                await OpenAIAssistentGroup.addFileToAssistentCall.call(
