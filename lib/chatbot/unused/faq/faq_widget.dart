                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if ((_model.getAsistnetINFO?.succeeded ?? true)) {
                                if ((OpenAIAssistentGroup
                                  ...
                                  if ((_model.mDeleteUploadedFile?.succeeded ??
                                      true)) {
                                    ...
                                    if ((_model.mDeleteVectorStore?.succeeded ??
                                        true)) {
                                      ...
                                      if ((_model
                                        ...
                                        if ((_model
                                          ...
                                          if ((_model.mLinkFileToVectorStore
                                            ...
                                            if ((_model.mLinkVectorToAsistent
                                                    ?.succeeded ??
                                                true)) {
                                  ...
                                  if ((_model.fGeneratedFile?.succeeded ??
                                    ...
                                    if ((_model.fLinkFileToVector?.succeeded ??
                                        true)) {
                                      ...
                                      if ((_model.fLinkVectorToAsistent
                                        ...
                                        await currentUserReference!
                                            .update(createUserTableRecordData(
                                          fAQData: functions.convertToOneline(
                                              _model.textController.text),
                                        ));
                                      } else {
                                        ScaffoldMessenger.of(context)
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              _model.apiResultabq = await OpenAICall.call(
                                ...
                                inputDate: functions.convertToOneline(
                                    _model.textController.text),
                                token: getRemoteConfigString('openAI_key'),
                              );
                              if ((_model.apiResultabq?.succeeded ?? true)) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Data is formatted.',
